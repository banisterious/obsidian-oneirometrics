...
- [Recent Issues and Fixes](#recent-issues-and-fixes)
...
- [Contributing](#contributing)
  - [UI Improvements](#ui-improvements-1)
...
- [Performance Tracking](#performance-tracking)
  ...
  - [Potential Additional Metrics](#potential-additional-metrics)
- [Development Notes](#development-notes)
  - [Logging Configuration](#logging-configuration)
- [Recent Fixes (May 2025)](#recent-fixes-may-2025)
- [Current Issues (May 2025)](#current-issues-may-2025)
- [Current Issues and Status](#current-issues-and-status)
  - [CSS Refactoring](#css-refactoring)
  - [Recent Changes](#recent-changes-1)
...
- [[May 2025] Settings Page Regression and Resolution](#may-2025-settings-page-regression-and-resolution)
  - [Issue](#issue)
  - [Resolution](#resolution)
  - [Note](#note)
- [OneiroMetrics Scrape Modal Fixes (v0.3.7)](#oneirometrics-scrape-modal-fixes-v037)
- [TODOs from Settings Page Review](#todos-from-settings-page-review)
